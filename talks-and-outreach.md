...
- In August 2018, I gave a lecture for the [CDT in Quantum Technologies](https://www.ucl.ac.uk/quantum/study-here/quantum-doctoral-programmes) on [*Markov chains*](https://en.wikipedia.org/wiki/Markov_chain).
...
- In March 2017, I gave a guest lecture for the Quantum Computation course in the [CDT in Quantum Technologies](https://www.ucl.ac.uk/quantum/study-here/quantum-doctoral-programmes) on the [*HHL algorithm*](https://en.wikipedia.org/wiki/Quantum_algorithm_for_linear_systems_of_equations). This is a quantum algorithm for solving linear systems of equations that under certain conditions is exponentially faster than any classical method. My typed notes can be found [here](https://github.com/ddervs/ddervs.github.io/raw/master/assets/pdfs/HHL.pdf).

- In the 2017/18 academic year I demonstrated for the [Principles of Programming course](https://wiki.ucl.ac.uk/display/CSCS/Computer+Science+Current+Students) for the UCL Computer Science Department. This course is a first introduction to programming for undergraduates, using C.
...
- In February 2018, I gave a talk to year 9 students about careers in science, as part of the [TechGirls](http://www.wearetechgirls.com) Challenge 2017. The talk was a small part of a larger event, in which the students got to experiment with the [IBM Quantum Experience](https://quantum.ibm.com/).
...
My colleagues in [Alexandra Olaya-Castro's Group](https://www.ucl.ac.uk/amopp/people/dr-alexandra-olaya-castro) in the Physics department at UCL have an outreach programme for their research, the [Quantum Secrets of Photosynthesis](https://www.ucl.ac.uk/impact/case-studies/2022/apr/inspiring-two-million-people-quantum-biology). They describe what they do most elegantly:
...
In the summer of 2016, I volunteered at their exhibit for the [Royal Society Summer Science Exhibition](https://royalsociety.org/news/2016/06/summer-science-exhibition-2016/), where we wowed the public with interactive displays illuminating how plants and bacteria use quantum mechanics to absorb and transfer energy more efficiently than thought possible.
